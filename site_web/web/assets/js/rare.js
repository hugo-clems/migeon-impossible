...
$(document).on("rare.charty", function () {
...
$(document).on("rare.fullscreen", function () {
...
$(document).on("rare.side", function () {
  Side.responsive();
  // var _cb;
...
$(document).on("rare.plugin", function () {
  if ($('.counterup').length) {
    Pluggin.counterup({
      delay: 10,
      time: 1000
