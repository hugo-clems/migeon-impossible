/**
 * Rare - Responsive Admin Dashboard Template
 * @version v1.0
 * @author CpBootstrap
 */
'use strict';
...
var rare = function () {
  ...
  var rare = function rare() {
    _classCallCheck(this, rare);
  };
...
rare.prototype.cleave = function () {
...
rare.prototype.colorpicker = function () {
  if ($.fn.colorpicker) {
    $(function () {
...
rare.prototype.wizard = function () {
...
rare.prototype.Morris = function () {
  Morris.Line({
    element: 'lineMorris',
    data: [{
      y: '2006',
...
rare.prototype.inlineChart = function () {
...
rare.prototype.FullCalendar = function () {
